...
<?php
    function getMenu(){
        ...
        if($role == 'admin') $html.="<li class='menuLine'><img class='iconMenu' src='images/icons/multiple-users-silhouette.png'><a href='accounts.php' id='page'>Gérer les comptes</a></li>";
        if($role == 'ecriture' || $role == 'admin') $html.= "<li class='menuLine'><img class='iconMenu' src='images/icons/tag.png'><a href='tags.php' id='page'>Gérer les tags</a></li>";
        ...
        $html .= "</ul>
            <li class='standaloneMenuLine'><img id='iconMenuDisconnect' src='images/icons/exit.png'><a id='page' href='logout-action.php'>Déconnexion</a></li>
        </ul>
        </div>";
    return $html;
    }
