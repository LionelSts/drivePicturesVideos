...
if(isset($_POST)){
	...
	switch ($_POST['mailType']) {
		...
		case 'mdpChoisis':
            ...
            $message = str_replace('registerLink', 'index.php', $message);  // message du mail avec lien
			break;
		case 'compteGoogle':
	...
	$message = str_replace('TEXTEVAR', $messageBienvenu, $message);  // message du mail avec lien
